...
if __name__ == "__main__":
    # Set up logging
    logging.basicConfig(
        filename='log_concept_contributions.log',
        level=logging.INFO,
    ...
    logging.info(f"Sparse: {args.sparse}")
    ...
    logging.info(f"Concept Contribution file saved to: {prefix + 'Concept_contribution' + W_g_path.split('/')[-1][3:-3] + '.txt'}")