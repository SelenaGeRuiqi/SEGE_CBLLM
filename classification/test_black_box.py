...
if __name__ == "__main__":
    # Set up logging
    logging.basicConfig(
        filename='log_blackbox_test.log',
        level=logging.INFO,
    ...
    # Suppress dataset metadata warnings
    ...
    logging.info(f"Tune MLP Only: {args.tune_mlp_only}")
    logging.info(f"Projection Dim: {args.projection_dim}")
    ...
    logging.info(f"Accuracy: {result['accuracy']:.4f}")
    print(result)